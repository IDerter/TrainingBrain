...
public class OnClickButton4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (PlayerTimer == true && timeintwork >= 16f)
        {
        ...
        if ((NewMasiveRandom[0] == NewMasiveInput[0]) && (NewMasiveRandom[1] == NewMasiveInput[1]) && (NewMasiveRandom[2] == NewMasiveInput[2]) && (NewMasiveRandom[3] == NewMasiveInput[3]) && (NewMasiveRandom[4] == NewMasiveInput[4] && (NewMasiveRandom[5] == NewMasiveInput[5] && (NewMasiveRandom[6] == NewMasiveInput[6]) && (NewMasiveRandom[7] == NewMasiveInput[7]) && (NewMasiveRandom[8] == NewMasiveInput[8])&& (NewMasiveRandom[9] == NewMasiveInput[9]))))
        {
           ...
           // obshtime.SetActive(true);
            if (PlayerPrefs.GetInt("Score4") > timeint && PlayerPrefs.HasKey("Score4") == true)
            {
                timeint = (int)timeStart;
                PlayerPrefs.SetInt("Score4", timeint);
            ...
            {
                if (PlayerPrefs.GetInt("Score4") == 0 && PlayerPrefs.HasKey("Score4") == false)//если игрок с первой попытки нажал все правильно
                {
        ...
        {
            if ((a == 10) && (PlayerPrefs.HasKey("Score4") == false))
            {
                //timeStart = 0f;
