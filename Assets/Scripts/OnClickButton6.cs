...
public class OnClickButton6 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        StartCoroutine(WaitAndPrint6(5f));
        /*if (k == 0)
        {
            j = 1;
        }
    ...
    void Update()
    {
        ...
        if (PlayerTimer == true&&timeintwork>=5f)
        {
        ...
        if ((NewMasiveRandom[0] == NewMasiveInput[0]) && (NewMasiveRandom[1] == NewMasiveInput[1]) && (NewMasiveRandom[2] == NewMasiveInput[2]) && (NewMasiveRandom[3] == NewMasiveInput[3]))
        {
            // timeStart = 1000f;
            ...
            if (PlayerPrefs.GetInt("Score5") > timeint && PlayerPrefs.HasKey("Score5") == true)
            {
                timeint = (int)timeStart;
                PlayerPrefs.SetInt("Score5", timeint);
            ...
            {
                if (PlayerPrefs.GetInt("Score5") == 0 && PlayerPrefs.HasKey("Score5") == false)//если игрок с первой попытки нажал все правильно
                {
